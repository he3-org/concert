...
<skills>
Read `.claude/skills/concert-core/SKILL.md` for: boot sequence, state management, next_action protocol, open questions identification, commit conventions, user guidance templates.
</skills>
...
8. **Update state.json** — Update `history[]`. Write `next_action`: `{ type: "await_user", target: "review_or_accept", message: "Review round complete" }`
