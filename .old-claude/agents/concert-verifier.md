...
6. **Write** `.concert/missions/<mission>/VERIFICATION.md`:
   - Summary counts (PASS/PARTIAL/FAIL/UNTESTABLE)
   - Per-requirement results with evidence
   - Gap analysis
   - Remediation suggestions

7. **Write** `.concert/missions/<mission>/COST-REPORT.md`:
...
📄 Reports:
  - .concert/missions/<mission>/VERIFICATION.md
  - .concert/missions/<mission>/COST-REPORT.md
