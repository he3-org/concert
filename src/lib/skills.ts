...
/**
 * Skills live under `.github/skills/<skill-name>/` in the assets repo.
 * Each skill is a folder containing a `SKILL.md` plus optional supporting files.
 */
export const SKILLS_PATH = '.github/skills';

// Re-export shared assets helpers for backward compatibility with consumers
